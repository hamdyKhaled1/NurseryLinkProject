        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemperatureReading = table.Column<double>(type: "float", nullable: true),
                    VisitType = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NurseryClasses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentCode = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DateOfBirth = table.Column<DateOnly>(type: "date", nullable: true),
                    ClassId = table.Column<int>(type: "int", nullable: true),
                    NurseryClassId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Users", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Users_NurseryClasses_NurseryClassId",
                        column: x => x.NurseryClassId,
                        principalTable: "NurseryClasses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NurseryClasses_TeacherId",
                table: "NurseryClasses",
                column: "TeacherId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_NurseryClasses_Users_TeacherId",
                table: "NurseryClasses",
                column: "TeacherId",
                principalTable: "Users",
                principalColumn: "Id");
